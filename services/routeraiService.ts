...
- Если позиции НЕТ в прайс-листе - всё равно верни её с правильным quantitySource
- Ищи максимально близкое совпадение в прайс-листе, но если не нашёл - верни как есть
- Для новых позиций (которых нет в прайс-листе) suggestedPrice может быть 0 или не указан - это нормально
