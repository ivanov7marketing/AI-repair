...
3. КОЛИЧЕСТВО:
   ...
   - Если пользователь НЕ назвал количество - определи quantitySource по типу работы:
     * Грунтовка стен, штукатурка стен, шпаклёвка стен, покраска стен, обои, плитка на стены, декоративная штукатурка = работа со СТЕНАМИ → wallArea
     ...
     * Если непонятно к чему относится - используй fixed (quantity=1)
